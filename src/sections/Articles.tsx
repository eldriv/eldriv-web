...
const Articles = [
  {
    ...
    topic: "Programming",
    text: "In software development, engineers require tools that prioritize efficiency and flexibility. When dealing with complex systems, there’s a constant need for...",
    avatar: memojiAvatar1,
  },
  {
    name: "A Wanderer's Tale of Discovering Lisp",
    topic: "Programming",
    text: "In February 2024, I felt lost in an unfamiliar forest, where a strong aura seemed to fill the air as if someone were watching me. The path beneath my feet...",
    avatar: memojiAvatar2,
  },
  {
    name: "Using Tmux to Perk Up Your Terminal Experience",
    topic: "System Administration",
    text: "As engineers, one of the essential tools we've always relied on is the terminal, due to its efficieny and speed that allows us to execute commands directly...",
    avatar: memojiAvatar3,
  },
  {
    name: "How NixOS Treated a Novice Sysadmin",
    topic: "Operating System",
    text: "For anyone reading this article now, you might be wondering why I chose such a title. Have you ever seen someone who is very skilled in programming but struggles...",
    avatar: memojiAvatar4,
  },
  {
    name: "Docker Containers Are Fast",
    topic: "System Administration",
    text: "Hello there! From the last article, I mentioned NixOS, right? My machine fully supports NixOS, and my experiences so far have exceeded my expectations...",
    avatar: memojiAvatar5,
  },
  {
    name: "Testing a Testing Framework",
    topic: "Quality Testing",
    text: "I’ve been working with Common Lisp for about eight months now, and I’ve become curious about how to test my code in this language, similar to how it's done in...  ",
    avatar: memojiAvatar6,
  },
  {
    name: "Explore Parsing in S-expression",
    topic: "Programming",
    text: "Parsing is a technique where we use to analyze and understand the structure of a text or code in order to extract meaningful information. This process involves...",
    avatar: memojiAvatar7,
  },
  {
    name: "How I Installed Ubuntu From Windows",
    topic: "Operating System",
    text: "I have been using Windows for about 10 years, so switching to a different operating system was a brave move for me. I chose Ubuntu Linux as my new companion...",
  ...
  <div className="py-20 lg:py-24">
    ...
    [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] py-4 -my-4">
      ...
      {Articles.map(articles => (
        <Card key={articles.name} className="max-w-xs md:max-w-md p-6 md:p-8 hover:-rotate-3 transition duration-300">
